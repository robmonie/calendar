(function() {
  ...
  var BASIC_FIELD_TEMPLATE_STRING = "{{view view.fieldView}}{{#if view.hintOrErrorText}}<div class=\"help-block\">{{view.hintOrErrorText}}</div>{{/if}}";
  var BASIC_FIELD_TEMPLATE = Ember.Handlebars.compile(BASIC_FIELD_TEMPLATE_STRING);
  var CONTROL_GROUP_TEMPLATE = Ember.Handlebars.compile("<label class=\"control-label\">{{view.label}}</label>\n<div class=\"controls\">\n  " + BASIC_FIELD_TEMPLATE_STRING + "\n</div>");
