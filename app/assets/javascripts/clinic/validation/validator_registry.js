...
*
*/
Calendar.validatorRegistry = Ember.Object.create({
...
*/
Calendar.validatorRegistry.addValidator('email', {
    isValid: function(value) {
...
*
*/
Calendar.validatorRegistry.addValidator('maxLength', Ember.Object.extend({
  max: null,
...
*
*/
Calendar.validatorRegistry.addValidator('minLength', Ember.Object.extend({
  min: null,
  constraintString: null,
  init: function() {
...
*
*/
Calendar.validatorRegistry.addValidator('numberRange', Ember.Object.extend({
  min: null,
  max: null,
  constraintString: null,
  init: function() {
